  ...
  return (
    <div className="card mb-10 border border-[#5865F2]/50 bg-[#5865F2]/10 shadow-[0_0_20px_rgba(88,101,242,0.1)]">
      ...
      <p className="text-sm text-zinc-400 mb-4">
        Paste your Discord Webhook URL here to enable exam teaser pings and announcements.
      </p>
      <div className="space-y-3">
        <div>
          <label className="block text-xs font-semibold text-zinc-300 mb-1">Discord Webhook URL</label>
          <input
            type="url"
            value={url}
